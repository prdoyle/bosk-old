 ...
 * @author pdoyle
 */
final class MultiDocumentMongoChangeStreamReceiver<R extends Entity> implements MongoReceiver<R> {
	...
	MultiDocumentMongoChangeStreamReceiver(BoskDriver<R> downstream, Reference<R> rootRef, MongoCollection<Document> collection, Formatter formatter, MongoDriverSettings settings) {
...
//				}
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(MultiDocumentMongoChangeStreamReceiver.class);
